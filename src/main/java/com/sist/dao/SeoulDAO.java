...
public class SeoulDAO {
   ...
   *      <update id="hitIncrement" parameterType="hashmap">
		  ...
		  <select id="seoulDetailData" resultType="SeoulVO"
  ...
  /*
   *   데이터 읽기 : select
   *   데이터 갱신 : insert / update , delete => commit 설정 
   *   => commit
   *   
   *   SqlSession session=ssf.openSession(); autocommit => false 
